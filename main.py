...
import utils
#import models.dmf_ablation
import models.dmf_final
...
def get_args_parser():
    ...
    parser.add_argument('--head_dropout', type=float, default=0.0, metavar='PCT',
...
def main(args):
    ...
    flops = FlopCountAnalysis(model.eval(), input)
